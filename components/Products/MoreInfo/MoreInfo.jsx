...
import RobotContaSlider from "../RobotContaSlider/RobotContaSlider";
   ...
   <div>
     <div className={styles.moreInfoContainer}>
      <div className={styles.sidebar}>
        ...
        <div className={styles.requestBatton}>Оставить заявку</div>
      </div>
      <div className={styles.rightSection}>
        ...
        <div  className={styles.downloadContainer}>
            ...
            <img src="/images/icons/download-icon-blue.svg"/>
            </div>
        </div>
